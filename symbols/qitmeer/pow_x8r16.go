...
func (this *X8r16) Update() {
	...
	if this.Pool {
		...
		this.header.PackagePoolHeader(this.Work, pow.X8R16)
	} else {
...
func (this *X8r16) Mine(wg *sync.WaitGroup) {
	defer wg.Done()
	defer this.Release()
	var w core.BaseWork
	for {
